...
`r colorize("*** Just a reminder, *Sections I-VI* are not in order, per se. It is just a list to lay out different topics we would like you to start to get familiar with.", "dimgrey")`
...
`r colorize("*** I’d like to thank Alice, Forrest, Haley, Jill, Julian, Paige, and Patrick for kindly sharing their thoughts and brilliant ideas and Amber and Ryan for giving wonderful feedback!", "dimgrey")`
