...
-   Hypothesis Test
    ...
    4.  Standard Error of the Estimated Intercept and Slope: $SE(A)$ &
        $SE(B)$
    ...
    $t=\frac{b_1-\beta_1}{SE(b_1)}=\frac{b_1-0}{SE(b_1)}=\frac{0.3895028-0}{0.6554015}=0.5942964$
    ...
    Now again, let's compare our t-statistic of $b_1$ with the t critical value.
